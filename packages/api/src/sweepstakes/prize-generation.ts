...
export const PRIZE_TEMPLATE: PrizeTemplateItem[] = [
  { ruleType: "winner", label: "Tournament Winner", description: null, pct: 0.25, perGroup: false },
  { ruleType: "runner_up", label: "Runner-up", description: null, pct: 0.13, perGroup: false },
  { ruleType: "third_place", label: "Bronze (3rd-place playoff)", description: null, pct: 0.05, perGroup: false },
  { ruleType: "group_top", label: "Top of group", description: "Split across every group", pct: 0.15, perGroup: true },
  { ruleType: "group_bottom", label: "Bottom of group", description: "Split across every group", pct: 0.12, perGroup: true },
  { ruleType: "player_of_tournament", label: "Player of the Tournament", description: null, pct: 0.04, perGroup: false },
  { ruleType: "golden_boot", label: "Golden Boot", description: "Top scorer", pct: 0.04, perGroup: false },
  { ruleType: "most_cards", label: "Dirtiest team", description: "15pt red / 10pt yellow", pct: 0.04, perGroup: false },
  { ruleType: "least_conceded", label: "Best defence", description: "Lowest avg conceded", pct: 0.05, perGroup: false },
  { ruleType: "most_possession", label: "Most possession", description: null, pct: 0.04, perGroup: false },
  { ruleType: "least_possession", label: "Least possession", description: null, pct: 0.04, perGroup: false },
  { ruleType: "biggest_loss", label: "Biggest single-game loss", description: null, pct: 0.05, perGroup: false },
];
